...
void getByteFrequency2(FILE *entrada, unsigned int *listaBytes)
{
...
void CompressFile(const char *arquivoEntrada, const char *arquivoSaida)
{
    ...
    getByteFrequency2(entrada, listaBytes);
...
int main_LOL(int argc, char *argv[])
{
    ...
    CompressFile("text.txt", "text.ed2");
